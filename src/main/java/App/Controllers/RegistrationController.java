...
public class RegistrationController implements Initializable, Localization {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        toLoginButton.setOnAction(new ChangeSceneHandler("/scenes/login/login.fxml"));
        ...
        loginButton.setOnAction(event -> {
            ...
            String answer = Authentication.register(login, password);
            if(answer.isEmpty()){
                ...
                errorText.setText(CurrentLanguage.getCurrentLanguage().getString(answer));
    ...
    public void setLanguage() {
        ...
        loginLabel.setText(currentLanguage.getString("registerLabel"));
        loginButton.setText(currentLanguage.getString("registerButton"));
        ...
        toLoginButton.setText(currentLanguage.getString("toLoginButton"));
    }
